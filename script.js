...
shopMenuButton2.physics = 'static';

let shopMenuText2 = new Sprite(530, 100, 100, 35);
shopMenuText2.physics = 'static';
...
shopMenuButton3.physics = 'static';

let shopMenuText3 = new Sprite(530, 150, 100, 35);
shopMenuText3.physics = 'static';
...
shopMenuButton4.physics = 'static';

let shopMenuText4 = new Sprite(530, 200, 100, 35);
shopMenuText4.physics = 'static';
...
shopMenuButton5.physics = 'static';

let shopMenuText5 = new Sprite(530, 250, 100, 35);
shopMenuText5.physics = 'static';
...
shopMenuButton6.physics = 'static';

let shopMenuText6 = new Sprite(530, 300, 100, 35);
shopMenuText6.physics = 'static';
...
if (page == 0) {
  ...
  //star button clicked
  	if (mouse.pressing() && pointer.overlapping(startButton)) {
    	...
    	setTimeout(() => { startButton.img = playButton; startButton.y = 70;}, 100);
    	page = 2;
//   }
// //page 0 - start
// 	if (page == 0) {
...
// 		if (mouse.presses() && pointer.overlapping(startButton)) {
